                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" class="form-control" placeholder="Company" name="email" value="<?php if (empty($row['Email'])) {
                                                                                                                                echo "";
                                                                                                                            } else {
                                                                                                                                echo $row['Email'];
                                                                                                                            } ?> " readonly>
                                ...
                                <div class="col-md-6 pl-1">
                                    <div class="form-group">
                                        <label>Number</label>
                                        <input type="text" class="form-control" placeholder="Last Name" name="number" value="<?php if (empty($row['MobileNumber'])) {
                                                                                                                                    echo "";
                                                                                                                                } else {
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" class="form-control" placeholder="Home Address" name="address" value="<?php if (empty($row['Address'])) {
                                                                                                                                        echo "";
                                                                                                                                    } else {
                                                                                                                                        echo $row['Address'];
                                                                                                                                    } ?>" readonly>
