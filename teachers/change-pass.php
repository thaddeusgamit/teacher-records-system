                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <form action="" method="post">
                                <div class="form-outline mb-4">
                                    <input type="password" id="typePasswordX-2" class="form-control form-control-lg" name="password" maxlength="30" required />
                                    <label class="form-label" for="typePasswordX-2">Password</label>
                                </div>

                                <div class="form-outline mb-4">
                                    <input type="password" id="typePasswordX-2" class="form-control form-control-lg" name="con_paswword" maxlength="30" required />
                                    <label class="form-label" for="typePasswordX-2">Confirm Password</label>
                                </div>

                                <!-- Checkbox -->

                                <input type="submit" class="btn btn-primary btn-lg btn-block" name="submit" value="Change Pass">
...
if (isset($_POST['submit'])) {
    ...
    if ($password == $password2) {
        ...
        $stmt = $conn->prepare("SELECT `Email` FROM `tblteacher` WHERE Email = ? ");
        ...
        if ($stmt) {
            ...
            $reset = $conn->prepare("UPDATE `tblteacher` SET `password`=? WHERE Email =?");
            $reset->bind_param('ss', $hashed_password, $email);
            $reset->execute();
