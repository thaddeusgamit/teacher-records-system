                    ...
                    "rowCallback": function(row, data, index) {
                        $(row).on('click', function() {
                            ...
                            var content = '<p>Name: ' + name + '</p>' +
                                '<p>Email: ' + email + '</p>' +
                                'Mobile Number: ' + number + '</p>' +
                                '<textarea class="form-control" id="floatingTextareaDisabled" readonly>' + message + '</textarea>';

                            $('#exampleModal .modal-body').html(content);
                            $('#exampleModal .modal-title').text('Messages');
