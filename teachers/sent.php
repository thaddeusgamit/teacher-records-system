                ...
                <div class="row">
                    <div class="card ">
                        <div class="card-header">
                            <h4 class="card-title">Sent items</h4>
                        </div>
                        <div class="card-body">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var dataTable = $('table').DataTable({
                    "ajax": "sent_data.php", // URL to server-side script that returns JSON data
                    "columns": [{
                            "data": "receiver"
                    ...
                    "rowCallback": function(row, data, index) {
                        $(row).on('click', function() {
                            window.location.href = 'view.php?sid=' + data.sid;
                        });
                    },
...
allowEscapeKey: false,
 ...
 window.location = 'sent.php';
  ...
  if (result.isConfirmed) {
    window.location = 'delete-sent.php?sid=$sid ';
