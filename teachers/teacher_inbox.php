...
<head>
    ...
    <link href="../src/css/paper-dashboard.min.css" rel="stylesheet">
                    ...
                    <div class="row">
                        <div class="card ">
                            <div class="card-header">
                                <h4 class="card-title"> Teachers Inbox </h4>
                            </div>
                            <div class="card-body">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var dataTable = $('table').DataTable({
                                "ajax": "teachers_inbox_data.php", // URL to server-side script that returns JSON data
                                "columns": [{
                                        "data": "sender"
                                    },
                                    {
                            ...
                            $('.dataTables_filter input').attr('maxLength', 17),
